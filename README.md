...
* Go / Golang es un lenguaje de programación open source echo por Google
...
* Usa structs y composición para modelar objetos
* No tiene excepciones (no tiene try/catch)
* Manejo de concurrencia simple
* Sistema de paquetes simples
* Distribución sencilla de binarios/ejecutables (sin necesidad de dependencias externas, su compilación esta para todos los SO y soporta todo tipo de arquitecturas)
...
<div>
  <h3>Descargar Go</h3>
  <p>Para descarga e instalar Go desde la documentación.</p>
